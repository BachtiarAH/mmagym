            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1>Build Your <em>BEST BODY</em></h1>
                        <p>Lava <a href="#">HTML landing page</a> template is provided by <a href="#">TemplateMo</a>.
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam cum natus neque commodi et, error perspiciatis exercitationem minus. Odit accusantium quae error enim? Deserunt dolore dolorem maxime nemo iure eaque?
                    </div>
                </div>
            </div>
        </div>
